...
for option, value in options:	
	...
	if option in ("--db_instance_class"):
		db_instance_class = value
		var_check_write('db_instance_class', db_instance_class)
	if option in ("--db_instance_storage"):
		db_instance_storage = value
		var_check_write('db_instance_storage', db_instance_storage)
	if option in ("--security_ip_list"):
		security_ip_list = value
		var_check_write('security_ip_list', security_ip_list)
