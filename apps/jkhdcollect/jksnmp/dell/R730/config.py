...
def oid_lable_num():  
    ...
    # 私有
    oid_dict['systemModelName']             = '.1.3.6.1.4.1.674.10892.5.1.3.12'              # 型号  (string)
    # power     
    oid_dict['powerSupplyType']             = '.1.3.6.1.4.1.674.10892.5.4.600.12.1.7'        # 电源类型
    oid_dict['powerSupplyStatus']           = '.1.3.6.1.4.1.674.10892.5.4.600.12.1.5'        # 电源状态     
    oid_dict['powerSupplyLocationName']     = '.1.3.6.1.4.1.674.10892.5.4.600.12.1.15'       # 电源名称       		

    oid_dict['systemFQDN']                  = '.1.3.6.1.4.1.674.10892.5.1.3.1'               # 系统主机名 (string)
    oid_dict['systemOSName']                = '.1.3.6.1.4.1.674.10892.5.1.3.6'               # 操作系统 (string)
    oid_dict['racFirmwareVersion']          = '.1.3.6.1.4.1.674.10892.5.1.1.8'               # 固件版本 FW version(string)
    ...
    # cpu
    oid_dict['processorDeviceStatus']           = '.1.3.6.1.4.1.674.10892.5.4.1100.30.1.5'    # 状态 
    oid_dict['processorDeviceManufacturerName'] = '.1.3.6.1.4.1.674.10892.5.4.1100.30.1.8'    # CPU厂商
    oid_dict['processorDeviceCoreCount']        = '.1.3.6.1.4.1.674.10892.5.4.1100.30.1.17'   # CPU插槽数
    oid_dict['processorDeviceVersionName']      = '.1.3.6.1.4.1.674.10892.5.4.1100.30.1.16'   # 处理器版本
    oid_dict['processorDeviceBrandName']        = '.1.3.6.1.4.1.674.10892.5.4.1100.30.1.23'   # CPU 型号
    # 内存
    ...
    oid_dict['memoryDeviceSize']            = '.1.3.6.1.4.1.674.10892.5.4.1100.50.1.14'      # 内存大小
    #风扇
    ...
    # 磁盘
    oid_dict['physicalDiskCapacityInMB']    = '1.3.6.1.4.1.674.10892.5.5.1.20.130.4.1.11'    # 磁盘大小
    oid_dict['physicalDiskState']           = '1.3.6.1.4.1.674.10892.5.5.1.20.130.4.1.4'     # 磁盘状态     
    oid_dict['physicalDiskMediaType']       = '1.3.6.1.4.1.674.10892.5.5.1.20.130.4.1.35'    # 磁盘类型
    oid_dict['physicalDiskDisplayName']     = '1.3.6.1.4.1.674.10892.5.5.1.20.130.4.1.55'    # 磁盘名称    
