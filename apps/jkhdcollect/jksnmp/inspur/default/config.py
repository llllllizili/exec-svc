...
def oid_lable_num():  
    ...
    # oid_dict['systemFQDN']                  = '.1.3.6.1.4.1.37945.2.2.1.1.4.2.0'             # 系统主机名 (string)
    ...
    # oid_dict['powerSupplyStatus']           = '.1.3.6.1.4.1.37945.2.1.2.7.1.1.3.0'                # 电源状态     
    # oid_dict['powerSupplyLocationName']     = '.1.3.6.1.4.1.37945.2.3.1.1.1.2.0'               # 电源名称

    # cpu
    # oid_dict['processorDeviceVersionName']      = '.1.3.6.1.4.1.232.1.2.2.1.1.5'            # 处理器版本
    # oid_dict['processorDeviceStatus']           = '.1.3.6.1.4.1.37945.2.1.2.4.1.1.3.0'            # 状态 
    ...
    # 内存
    # oid_dict['memoryDeviceStatus']              = '.1.3.6.1.4.1.37945.2.1.1.2.1.1.3.0'       # 内存状态
    # oid_dict['memoryDeviceSpeed']               = '.1.3.6.1.4.1.37945.2.1.1.2.1.1.8.0'       # 内存速率(Mhz)
    # oid_dict['memoryDeviceType']                = '.1.3.6.1.4.1.37945.2.1.1.2.1.1.1.0'       # 内存类型
    # oid_dict['memoryDeviceManufacturerName']    = '.1.3.6.1.4.1.37945.2.1.1.2.1.1.5.0'       # 内存厂商
    # oid_dict['memoryDeviceSize']                = '.1.3.6.1.4.1.37945.2.1.1.2.1.1.7.0'       # 内存大小（MB）

    #风扇
    # oid_dict['coolingDeviceStatus']         = '.1.3.6.1.4.1.37945.2.1.2.3.1.1.3.0'           # 风扇状态
    # oid_dict['coolingDeviceReading']        = '.1.3.6.1.4.1.674.10892.5.4.700.12.1.6'        # 风扇转/分      
    # oid_dict['coolingDeviceLocationName']   = '.1.3.6.1.4.1.37945.2.1.2.3.1.1.2.0'           # 风扇名称

    # 磁盘
    # oid_dict['physicalDiskCapacityInMB']        = '.1.3.6.1.4.1.232.3.2.5.1.1.45'            # 磁盘大小（MB）
    # oid_dict['physicalDiskState']               = '.1.3.6.1.4.1.37945.2.1.3.1.1.1.4.0'       # 磁盘状态     
    # oid_dict['physicalDiskMediaType']           = '.1.3.6.1.4.1.232.3.2.5.1.1.60'            # 磁盘类型
    # oid_dict['physicalDiskDisplayName']         = '.1.3.6.1.4.1.37945.2.1.1.4.1.1.5.0'       # 磁盘名称    
