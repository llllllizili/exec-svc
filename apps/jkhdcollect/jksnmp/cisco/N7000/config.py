...
def oid_lable_num():  
    ...
    oid_dict['cdpCacheAddress']             = '1.3.6.1.4.1.9.9.23.1.2.1.1.4'
    oid_dict['vtpVlanState']                = '1.3.6.1.4.1.9.9.46.1.3.1.1.2'
    oid_dict['vtpVlanName']                 = '1.3.6.1.4.1.9.9.46.1.3.1.1.4'
    oid_dict['lldpLocChassisId']            = '1.0.8802.1.1.2.1.3.2'
    oid_dict['chassisModel']                = '1.3.6.1.4.1.9.5.1.2.16'
    return oid_dict
...
def oid_lable_desc():
    ...
    desc_dict['cdpCacheAddress']                = u'CDP网络层IP地址缓存'
    desc_dict['vtpVlanState']                   = u'VLAN状态'
    desc_dict['vtpVlanName']                    = u'VLAN名称'
    desc_dict['lldpLocChassisId']               = u'本地设备机箱ID'
